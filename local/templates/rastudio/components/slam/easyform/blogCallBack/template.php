    ...
    <div class="general-form">
        ...
        case 'textarea':?>
            ...
            <div class="general-itemInput">
                <textarea rows="1" oninput="auto_grow(this)" class="<?= $arField['CLASS'] ?>" id="<?=$arField['ID']?>" cols="30" name="<?=$arField['NAME']?>" <?=$arField['PLACEHOLDER_STR'];?> <?=$arField['REQUIRED']?'data-required':''?>><?=$arField['VALUE'];?></textarea>
                <script>
