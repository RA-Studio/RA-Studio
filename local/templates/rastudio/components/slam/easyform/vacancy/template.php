...
?>
    ...
    <form id="<?=$FORM_ID?>"
        ...
        <div style="display: none" class="alert alert-success  <?if($arResult['STATUS'] != 'ok'):?>hidden<?endif;?>" role="alert">
            <?=$arParams['OK_TEXT']?>
        </div>
        <div style="display: none" class="alert alert-danger <?if($arResult['STATUS'] != 'error'):?>hidden<?endif;?>" role="alert">
            <?=$arParams['ERROR_TEXT']?>
        ...
        <div class="vacancy-form-row">
            ...
            <input class="vacancy-form-row__input" type="tel" placeholder="Телефон" name="tel">
            <input class="vacancy-form-row__input" type="text" placeholder="Email" name="email">
