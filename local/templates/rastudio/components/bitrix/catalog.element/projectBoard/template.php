...
?>
    ...
    <div class="tasks-full-top" id="<?=$itemIds['ID']?>">
        <div class="tasks-full-projectImage">
            <div class="tasks-full-projectImage_default">
            ...
            <div class="tasks-main-item-projectImage_custom">
                <img src="<?=$arResult['PREVIEW_PICTURE']['SRC']?$arResult['PREVIEW_PICTURE']['SRC']:'/local/templates/rastudio/assets/images/empty_logo.svg'?>" alt="<?=$arResult['PREVIEW_PICTURE']['ALT']?>" title="<?=$arResult['PREVIEW_PICTURE']['TITLE']?>">
            </div>
        </div>
        <div class="tasks-main-item-afterImage">
            <p class="tasks-main-item-afterImage__name"><?=$arResult['NAME']?></p>
            <div class="tasks-main-item-afterImage__status">
                <svg width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="5" cy="5" r="5" fill="#219653"/></svg>
                <?=$arResult['PROPERTIES']['UF_ACTIVE']['VALUE']?>
            </div>
        </div>
    </div>
    <div class="tasks-full-centerFlex-wrap"><?
        if(!empty($arResult['DISPLAY_PROPERTIES'])){
            foreach ($arResult['DISPLAY_PROPERTIES'] as $PROPERTY){
                ?><div class="tasks-full-centerFlex">
...
<?if(!empty($arResult['DETAIL_TEXT'])){?>
    <div class="tasks-full-about">
        <h3 class="tasks-full__title">Информация о проекте</h3>
        <p class="tasks-full__text"><?=$arResult['DETAIL_TEXT']?></p>
    </div>
    <?}?>
<?$subProjects = [];
...
while($ob = $res->GetNextElement()) {
    if ($ob->GetProperties()['UF_SUB_PROJECT']['VALUE'] == $arResult['ID']) {
    $subProjects[] = $ob->GetFields()['ID'];
}

}
?>
<?if(!empty($subProjects)){?>
    <div class="tasks-full-subProject">
        <h3 class="tasks-full__title">Подпроекты</h3>
<?
$GLOBALS['subProjectFilter']['ID'] = $subProjects;
/*
