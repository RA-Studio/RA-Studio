    ...
    <div class="main-clients-items" data-aos="fade"><?
        foreach($arResult["ITEMS"] as $arItem){
            ...
            if (!empty($link) || !empty($case)){
                ?><a data-nolink href="<?=$case?$case:$link?>" target="_blank" class="main-clients-items-item" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
        ...
        ?>
        <a class="main-clients-items-add fancybox-btn-init" data-nolink title="Пишите, мы ответим" data-fancybox="" data-options="{&quot;src&quot;: &quot;#SendForm&quot;, &quot;touch&quot;: false}" href="javascript:;">
