...
?><div class="tasks">
    <div class="tasks-top"><?
        ...
        ?><a class="tasks-top__title" id="<?=$this->GetEditAreaId($arSection['ID']);?>" href="#tab<?=$arSection['ID']?>"><?=$arSection['NAME']?></a><?
            }
            unset($arSection);?>
    </div><?
    foreach ($arResult['SECTIONS'] as &$arSection){
        $this->AddEditAction($arSection['ID'], $arSection['EDIT_LINK'], $strSectionEdit);
        $this->AddDeleteAction($arSection['ID'], $arSection['DELETE_LINK'], $strSectionDelete, $arSectionDeleteParams);
        $GLOBALS['projectFilter']["PROPERTY_UF_SUB_PROJECT"] = false;
    ?><div class="tasks-main" id="tab<?=$arSection['ID']?>"><?
